...
public class Autor {
    ...
    public String toString() {
        String anoNascimentoStr = anoNascimento != null ? anoNascimento.toString() : "Desconhecido(a)";
        String anoFalecimentoStr = anoFalecimento != null ? anoFalecimento.toString() : "Desconhecido(a)";
